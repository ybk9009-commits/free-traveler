...
status: LOCKED
amendments:
  - "2026-09-19: colors.muted #83838A → #6B6B72 (TEST-A11Y-AXE — 원래 값은 #FFFFFF/#F7F6F4 배경에서 WCAG AA 4.5:1 명도 대비(REQ-NF-023)를 만족하지 못함, 실측 3.48:1). 시각적 톤(웜 그레이)은 유지하고 명도만 낮췄다."
source_of_truth:
...
| `{colors.muted}`                             | #6B6B72           | 캡션, 비활성 라벨, 타임스탬프               |
